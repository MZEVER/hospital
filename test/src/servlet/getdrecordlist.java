...
/**
 * Servlet implementation class getdrecordlist
 */
@WebServlet("/getdrecordlist")
public class getdrecordlist extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public getdrecordlist() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            ResultSet result;  
            String sqlQuery="select * from record where did='"+ did+"' order by time ";
