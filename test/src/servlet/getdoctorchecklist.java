...
/**
 * Servlet implementation class getdoctorchecklist
 */
@WebServlet("/getdoctorchecklist")
public class getdoctorchecklist extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public getdoctorchecklist() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {  
            ...
            ResultSet result;  
            String sqlQuery = "select did from daccount where ischeck = '0'";  
