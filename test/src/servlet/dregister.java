...
public class dregister extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {  
            ...
            ResultSet result;  
            String sqlQuery = "select * from " + DBUtil.TABLE_daccount + " where account='" + account + "'";  
            ...
            if(result.next()){ // 已存在  
                ...
                String sqlInsertPass = "insert into " + DBUtil.TABLE_daccount + "(account,password,ischeck) values('"+account+"','"+password+"','0')";  
