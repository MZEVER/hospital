...
public class register extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {  
            ...
            ResultSet result;  
            String sqlQuery = "select * from " + DBUtil.TABLE_paccount + " where account='" + account + "'";  
            ...
            if(result.next()){ // 已存在  
                ...
                String sqlInsertPass = "insert into " + DBUtil.TABLE_paccount + "(account,password) values('"+account+"','"+password+"')";  
